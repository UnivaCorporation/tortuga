...
This guide contains information for IT staff and end-users who will be installing, configuring, and managing Tortuga 7.0. Information about specific software kits is provided in the associated kit guides.
...
For example, if the installer is running CentOS 7.4, it stays at CentOS 7.4 for its lifetime. In other words, the 'updates' repository (defined in '/etc/yum.repos.d/CentOS-Base.repo') must be disabled.

**Note: No patched packages can be installed on the installer prior to installation of Tortuga!**

All compute nodes will be provisioned from the CentOS 7.4 OS media as supplied by the administrator.
