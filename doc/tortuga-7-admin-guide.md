...
- [Tortuga Quickstart](#tortuga-quickstart)
  - [Manual quickstart installation](#manual-quickstart-installation)
  - [Prerequisites](#prerequisites)
  - [Quickstart Installation](#quickstart-installation)
- [About Tortuga](#about-tortuga)
- [Supporting the Datacenter Lifecycle](#supporting-the-datacenter-lifecycle)
- [Understanding Tortuga Architecture](#understanding-tortuga-architecture)
- [Detailed Installation Guide](#detailed-installation-guide)
  - [Hardware and Software Requirements](#hardware-and-software-requirements)
  - [Operating Systems](#operating-systems)
  - [Network](#network)
  - [Disk Space](#disk-space)
  - [Hypervisor/Cloud Support](#hypervisorcloud-support)
  - [Compute Node Requirements](#compute-node-requirements)
  - [Preparing For Installation](#preparing-for-installation)
  - [Installing Tortuga](#installing-tortuga)
- [Tortuga Fundamentals](#tortuga-fundamentals)
- [Command-line interface](#command-line-interface)
  - [Software and Hardware profiles](#software-and-hardware-profiles)
  - [Hardware and software profile mapping](#hardware-and-software-profile-mapping)
  - [Kits and Components](#kits-and-components)
  - [Display list of installed kits](#display-list-of-installed-kits)
  - [Display all installed components](#display-all-installed-components)
  - [Users](#users)
  - [Configuring Tortuga for provisioning](#configuring-tortuga-for-provisioning)
- [Networking Requirements](#networking-requirements)
  - [Adding the Provisioning NIC](#adding-the-provisioning-nic)
- [Enabling Tortuga Components for Provisioning](#enabling-tortuga-components-for-provisioning)
  - [Package-based Node Provisioning](#package-based-node-provisioning)
- [Special Configurations](#special-configurations)
  - [Setting up NAT for Tortuga compute nodes](#setting-up-nat-for-tortuga-compute-nodes)
  - [Enable IP forwarding on the Tortuga installer](#enable-ip-forwarding-on-the-tortuga-installer)
  - [Enable NAT](#enable-nat)
- [Managing Clusters](#managing-clusters)
  - [Adding Nodes](#adding-nodes)
  - [Reboot and/or reinstalling nodes](#reboot-andor-reinstalling-nodes)
  - [Deleting nodes](#deleting-nodes)
  - [Idling and activating nodes](#idling-and-activating-nodes)
  - [Shutting down and Starting up Nodes](#shutting-down-and-starting-up-nodes)
  - [Transferring nodes between software profiles](#transferring-nodes-between-software-profiles)
  - [Node states](#node-states)
  - [Resource tagging](#resource-tagging)
- [Advanced Topics](#advanced-topics)
  - [Managing Operating System Updates](#managing-operating-system-updates)
  - [Puppet & MCollective](#puppet--mcollective)
  - [Tortuga Puppet Integration & Extensibility](#tortuga-puppet-integration--extensibility)
  - [Using Custom SSL Certificates](#using-custom-ssl-certificates)
- [Resource Adapters](#resource-adapters)
  - [Resource adapter configuration profiles](#resource-adapter-configuration-profiles)
- [Troubleshooting](#troubleshooting)
  - [Troubleshooting Overview](#troubleshooting-overview)
  - [Log file formatting and convention](#log-file-formatting-and-convention)
  - [Installation and setup logging](#installation-and-setup-logging)
  - [Logging Configuration](#logging-configuration)
  - [Adjusting default log level](#adjusting-default-log-level)
  - [Troubleshooting failed Tortuga installation](#troubleshooting-failed-tortuga-installation)
  - [Troubleshooting failed compute node provisioning](#troubleshooting-failed-compute-node-provisioning)
- [Appendix A: Tortuga End-User License Agreement (EULA)](#appendix-a-tortuga-end-user-license-agreement-eula)
...
11. (*optional*) Install AWS resource adapter
    ...
    *Hybrid and EC2-based installations only*
    ...
    enable-component -p --no-sync awsadapter-7.0.1-0 management-7.0.1
    ```
...
On Tortuga 7.0.1 (and later), the `set-private-dns-zone` command-line is
...
On Tortuga versions prior to 7.0.1, use `ucparam` to get the current
...
‘/opt/tortuga/depot/kits/base/7.0.1-0/noarch’.
...
`/opt/tortuga/depot/kits/base/7.0.1-0/noarch`, it is required to run
