...
class BooleanSettingSchema(BaseSettingSchema):
    ...
    def make_instance(self, data):
        from ..resource_adapter_settings import BooleanSetting
...
class FileSettingSchema(BaseSettingSchema):
    ...
    @post_load
    def make_instance(self, data):
        from ..resource_adapter_settings import FileSetting
...
class IntegerSettingSchema(BaseSettingSchema):
    ...
    @post_load
    def make_instance(self, data):
        from ..resource_adapter_settings import IntegerSetting
...
class StringSettingSchema(BaseSettingSchema):
    ...
    @post_load
    def make_instance(self, data):
        from ..resource_adapter_settings import StringSetting
