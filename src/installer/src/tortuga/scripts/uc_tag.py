...
def main():
    ...
    add_subparser.add_argument('--tag', action='append', dest='tags',
                               type=key_value_pair)
    add_subparser.set_defaults(func=add_tag)
    ...
    remove_subparser.add_argument('--tag', action='append', dest='tags',
                                  type=key_value_pair)
    remove_subparser.set_defaults(func=remove_tag)
    ...
    delete_subparser.set_defaults(func=delete_tag)
    ...
    list_subparser.set_defaults(func=list_tag)
...
def get_tag_objects(session, tags):
