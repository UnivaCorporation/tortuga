...
from tortuga.objects import resource_adapter_settings
...
class Default(ResourceAdapter):
    ...
    settings: Dict[str, resource_adapter_settings.BaseSetting] = {
        'boot_host_hook_script': resource_adapter_settings.FileSetting()
    }
